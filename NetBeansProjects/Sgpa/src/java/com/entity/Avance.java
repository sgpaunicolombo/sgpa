...
public class Avance implements Serializable {
    ...
    public boolean validarAvance() {
        ...
        if(this.getProyecto().getTitulo().equals("")){
            FacesUtil.addErrorMessage("Estos campos son requeridos");
            valido = false;
        }
        
        if (this.fase.equals("") || Integer.valueOf(this.numero).equals("")) {
            FacesUtil.addErrorMessage("Estos campos son requeridos");
            valido = false;
        }
        if (this.fechaEntrega.equals("") || this.integrante.equals("") || this.descripcion.equals("")) {
            FacesUtil.addErrorMessage("Estos campos son requeridos");
            valido = false;
        }
        return valido;
